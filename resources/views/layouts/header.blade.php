    ...
    <div class="topbar container-fluid">
        <div class="d-flex align-items-center gap-1">
            ...
            <div class="logo-topbar">
                ...
                <a href="index.html" class="logo-light">
                    <span class="logo-lg">
                        <img src="{{ asset('velonic/layouts/assets/images/logo.png')}}" alt="logo">
                    </span>
                    <span class="logo-sm">
                        <img src="{{ asset('velonic/layouts/assets/images/logo-sm.png')}}" alt="small logo">
                    </span>
                </a>
                ...
                <a href="index.html" class="logo-dark">
                    <span class="logo-lg">
                        <img src="{{ asset('velonic/layouts/assets/images/logo-dark.png')}}" alt="dark logo">
                    </span>
                    <span class="logo-sm">
                        <img src="{{ asset('velonic/layouts/assets/images/logo-sm.png')}}" alt="small logo">
                    </span>
        ...
        <ul class="topbar-menu d-flex align-items-center gap-3">
            ...
            <li class="dropdown">
                <a class="nav-link dropdown-toggle arrow-none" data-bs-toggle="dropdown" href="#" role="button"
                    aria-haspopup="false" aria-expanded="false">
                    <img src="{{ asset('velonic/layouts/assets/images/flags/us.jpg')}}" alt="user-image" class="me-0 me-sm-1" height="12">
                ...
                <div class="dropdown-menu dropdown-menu-end dropdown-menu-animated">
                    ...
                    <a href="javascript:void(0);" class="dropdown-item">
                        <img src="{{ asset('velonic/layouts/assets/images/flags/germany.jpg')}}" alt="user-image" class="me-1" height="12"> <span
                            class="align-middle">German</span>
                    </a>

                    <!-- item-->
                    <a href="javascript:void(0);" class="dropdown-item">
                        <img src="{{ asset('velonic/layouts/assets/images/flags/italy.jpg')}}" alt="user-image" class="me-1" height="12"> <span
                            class="align-middle">Italian</span>
                    </a>

                    <!-- item-->
                    <a href="javascript:void(0);" class="dropdown-item">
                        <img src="{{ asset('velonic/layouts/assets/images/flags/spain.jpg')}}" alt="user-image" class="me-1" height="12"> <span
                            class="align-middle">Spanish</span>
                    </a>

                    <!-- item-->
                    <a href="javascript:void(0);" class="dropdown-item">
                        <img src="{{ asset('velonic/layouts/assets/images/flags/russia.jpg')}}" alt="user-image" class="me-1" height="12"> <span
                                ...
                                <div class="d-flex align-items-center">
                                    <div class="flex-shrink-0">
                                        <div class="notify-icon">
                                            <img src="{{ asset('velonic/layouts/assets/images/users/avatar-1.jpg')}}" class="img-fluid rounded-circle"
                                                alt="" />
                                        </div>
                                    </div>
                        ...
                        <a href="javascript:void(0);"
                            ...
                            <div class="card-body">
                                <div class="d-flex align-items-center">
                                    <div class="flex-shrink-0">
                                        <div class="notify-icon">
                                            <img src="{{ asset('velonic/layouts/assets/images/users/avatar-2.jpg')}}" class="img-fluid rounded-circle"
                                                alt="" />
                                        </div>
                                    </div>
                                    <div class="flex-grow-1 text-truncate ms-2">
                        ...
                        <a href="javascript:void(0);"
                            ...
                            <div class="card-body">
                                <div class="d-flex align-items-center">
                                    <div class="flex-shrink-0">
                                        <div class="notify-icon">
                                            <img src="{{ asset('velonic/layouts/assets/images/users/avatar-3.jpg')}}" class="img-fluid rounded-circle"
                                                alt="" />
                                        </div>
                                    </div>
                                    <div class="flex-grow-1 text-truncate ms-2">
                        ...
                        <a href="javascript:void(0);"
                            ...
                            <div class="card-body">
                                <div class="d-flex align-items-center">
                                    <div class="flex-shrink-0">
                                        <div class="notify-icon">
                                            <img src="{{ asset('velonic/layouts/assets/images/users/avatar-4.jpg')}}" class="img-fluid rounded-circle"
                                                alt="" />
                                        </div>
                                    </div>
                                    <div class="flex-grow-1 text-truncate ms-2">
                        ...
                        <a href="javascript:void(0);"
                            ...
                            <div class="card-body">
                                <div class="d-flex align-items-center">
                                    <div class="flex-shrink-0">
                                        <div class="notify-icon">
                                            <img src="{{ asset('velonic/layouts/assets/images/users/avatar-5.jpg')}}" class="img-fluid rounded-circle"
                                                alt="" />
                                        </div>
                                    </div>
                                    <div class="flex-grow-1 text-truncate ms-2">
            ...
            <li class="dropdown">
                <a class="nav-link dropdown-toggle arrow-none nav-user" data-bs-toggle="dropdown" href="#" role="button"
                    ...
                    <span class="account-user-avatar">
                        <img src="{{ asset('velonic/layouts/assets/images/users/avatar-1.jpg')}}" alt="user-image" width="32" class="rounded-circle">
                    </span>
                ...
                <div class="dropdown-menu dropdown-menu-end dropdown-menu-animated profile-dropdown">
                    ...
                    <!-- item-->
                    <a href="{{ route('auth.log')}}" class="dropdown-item">
