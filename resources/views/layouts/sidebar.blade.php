<div class="leftside-menu">
    ...
    <div class="h-100" id="leftside-menu-container" data-simplebar>
        ...
        <ul class="side-nav">
            ...
            <li class="side-nav-item">
                <a data-bs-toggle="collapse" href="#contratMultiLevel" aria-expanded="false" aria-controls="contratMultiLevel" class="side-nav-link">
            ...
            <li class="side-nav-item">
                <a data-bs-toggle="collapse" href="#opeMultiLevel" aria-expanded="false" aria-controls="opeMultiLevel" class="side-nav-link">
            ...
            <li class="side-nav-item">
                <a data-bs-toggle="collapse" href="#clientMultiLevel" aria-expanded="false" aria-controls="clientMultiLevel" class="side-nav-link">
            ...
            <li class="side-nav-item">
                <a data-bs-toggle="collapse" href="#appMultiLevel" aria-expanded="false" aria-controls="appMultiLevel" class="side-nav-link">
            ...
            <li class="side-nav-item">
                <a data-bs-toggle="collapse" href="#utiMultiLevel" aria-expanded="false" aria-controls="utiMultiLevel" class="side-nav-link">
                    <i class="ri-group-line"></i>
            ...
            <li class="side-nav-item">
                <a href="" class="side-nav-link">
                    ...
                    <span class="badge bg-waring float-end"></span>
                    <span> PARAMETRE </span>
                </a>
            </li>
